...
myserver         18080    /home/ubuntu/ernz20-containers/demos/07_rstudio/tidyverse_long.sif
```
{: .output}
...
```
Stopping myserver instance of /home/ubuntu/ernz20-containers/demos/07_rstudio/tidyverse_long.sif (PID=18080)
```
{: .output}
